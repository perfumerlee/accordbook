...
root.render(
  <StrictMode>
    {isRev30Preview ? <Rev30Preview /> : operatorGuideRoute ? <><GuideEditor /><GuideLegacyRecovery /><GuidePublishProtocolCheck /></> : guideRoute ? <GuidePage /> : route.kind === 'drop-index' ? <FormulaDropLanguageProvider><FormulaDropIndexPage /></FormulaDropLanguageProvider> : route.kind === 'drop-detail' ? <FormulaDropLanguageProvider><FormulaDropDetailPage dropId={route.dropId} /></FormulaDropLanguageProvider> : route.kind === 'formula-storage' ? <LocalFormulaVaultPage /> : <ProductionWithIntro />}
  </StrictMode>,
)
