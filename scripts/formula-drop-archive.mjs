...
export function renderPage(shell, drop, archives) {
  ...
  const pageShell = shell.replace(/\s*(?:<meta name="description"[^>]*>|<link rel="canonical"[^>]*>|<meta property="og:[^"]+"[^>]*>|<meta name="twitter:[^"]+"[^>]*>|<script type="application\/ld\+json">[\s\S]*?<\/script>)/gi, '')
  return pageShell.replace(/<title>[\s\S]*?<\/title>/,pageMetadata(drop)).replace('<div id="root"></div>', `<div id="root"><main class="static-archive"><nav><a href="/">Accordbook</a> · <a href="/drop">All Drops</a></nav>${body}<footer><a href="/">Open Accordbook</a></footer></main></div>`).replace('</head>', '<style>.static-archive{max-width:960px;margin:auto;padding:48px 28px;color:#332d27;font:18px/1.7 Georgia,serif}.static-archive h1{font-size:48px;line-height:1.2;font-weight:normal}.static-archive section{margin:56px 0}.static-archive h2{font:13px monospace;text-transform:uppercase;letter-spacing:.1em}.static-archive li{padding:14px 0;border-bottom:1px solid #c8bdad}.static-archive a{color:#6f527f}.archive-prose{white-space:pre-line}</style></head>')
}
